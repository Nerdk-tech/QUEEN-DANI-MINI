...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    IMAGE_PATH: 'https://files.catbox.moe/1wbnlc.jpg',
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/BykKavWirfKBv1meRqMnKW?mode=ems_copy_t',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: 'https://files.catbox.moe/1wbnlc.jpg',
...
`;
        const aliveMessage = {
            image: { url: "https://files.catbox.moe/1wbnlc.jpg" },
            ...
            buttons: [
                {
                    ...
                    nativeFlowInfo: {
                        ...
                        paramsJson: JSON.stringify({
                            ...
                            sections: [
                                {
                                    title: `© 𝑄𝑈𝐸𝐸𝑁 𝐷𝐴𝑁𝐼 𝑀𝐼𝑁𝐼`,
                                    highlight_label: 'Quick Actions',
                                    rows: [
                                        { title: '📋 ғᴜʟʟ ᴍᴇɴᴜ', description: 'ᴠɪᴇᴡ ᴀʟʟ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴍᴅs', id: `${config.PREFIX}menu` },
                                        { title: '❤️‍🩹 ᴀʟɪᴠᴇ ᴄʜᴇᴄᴋ', description: 'ʀᴇғʀᴇs ʙᴏᴛ sᴛᴀᴛᴜs', id: `${config.PREFIX}alive` },
...
╰───────────────⭓`;
        ...
        const newsletterContext = {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: '𝑄𝑈𝐸𝐸𝑁 𝐷𝐴𝑁𝐼 𝑀𝐼𝑁𝐼',
                serverMessageId: -1
            }
        };
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: '𝑄𝑈𝐸𝐸𝑁 𝐷𝐴𝑁𝐼 𝑀𝐼𝑁𝐼' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              ...
              sections: [
                {
                  ...
                  highlight_label: '𝑄𝑈𝐸𝐸𝑁 𝐷𝐴𝑁𝐼 𝑀𝐼𝑁𝐼',
                  rows: [
            ...
            case 'fc': {
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363377534493877@newsletter'
                        });
                    }
                    ...
                    await socket.sendMessage(sender, { react: { text: '✔️', key: msg.key } });
                        ...
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '🌌 𝑄𝑈𝐸𝐸𝑁 𝐷𝐴𝑁𝐼 𝑀𝐼𝑁𝐼 ɴᴀsᴀ ɴᴇᴡs',
                                `🌠 *${title}*\n\n${explanation.substring(0, 200)}...\n\n📆 *ᴅᴀᴛᴇ*: ${date}\n${copyright ? `📝 *ᴄʀᴇᴅɪᴛ*: ${copyright}` : ''}\n🔗 *Link*: https://apod.nasa.gov/apod/astropix.html`,
                                'powered byy 𝑫𝑨𝑴𝑰 𝑰𝑺 𝑯𝑰𝑴'
                            )
                        });
                    } catch (error) {
...
case 'ai': {
    ...
    const prompt = `ʏᴏᴜʀ name is 𝑄𝑈𝐸𝐸𝑁 𝐷𝐴𝑁𝐼 𝑀𝐼𝑁𝐼. 
...
User Message: ${q}
  ...
  await socket.sendMessage(sender, {
        image: { url: 'https://files.catbox.moe/1wbnlc.jpg' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
...
//===============================
                  ...
                  await socket.sendMessage(sender, { react: { text: '🔮', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: imageBuffer,
                            caption: `🧠 *𝑄𝑈𝐸𝐸𝑁 𝐷𝐴𝑁𝐼 𝑀𝐼𝑁𝐼 ᴀɪ ɪᴍᴀɢᴇ*\n\n📌 ᴘʀᴏᴍᴘᴛ: ${prompt}`
                        }, { quoted: fakevCard });
                    } catch (err) {
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 𝑄𝑈𝐸𝐸𝑁 𝐷𝐴𝑁𝐼 𝑀𝐼𝑁𝐼 ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
...
case 'script': {
    try {
        await socket.sendMessage(sender, { react: { text: '🪄', key: msg.key } });
        const githubRepoURL = 'https://github.com/Nerdk-tech/QUEEN-DANI-MINI';
...
case 'repo-visit': {
    await socket.sendMessage(sender, { react: { text: '🌐', key: msg.key } });
    await socket.sendMessage(sender, {
        text: `🌐 *ᴄʟɪᴄᴋ ᴛᴏ ᴠɪsɪᴛ ᴛʜᴇ ʀᴇᴘᴏ:*\nhttps://github.com/Nerdk-tech/QUEEN-DANI-MINI`,
        contextInfo: {
            externalAdReply: {
                title: 'Visit Repository',
                body: 'Open in browser',
                mediaType: 1,
                mediaUrl: 'https://github.com/Nerdk-tech/QUEEN-DANI-MINI',
                sourceUrl: 'https://github.com/Nerdk-tech/QUEEN-DANI-MINI'
            }
        }
    }, { quoted: fakevCard });
    break;
